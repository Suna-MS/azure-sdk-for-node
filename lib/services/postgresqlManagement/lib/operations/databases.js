 ...
 */
Databases.prototype.createOrUpdate = function (resourceGroupName, serverName, databaseName, parameters, options, callback) {
  ...
  // Send request
  this.beginCreateOrUpdate(resourceGroupName, serverName, databaseName, parameters, options, function (err, parsedResult, httpRequest, response){
    ...
    client.getLongRunningOperationResult(initialResult, options, function (err, pollingResult) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['Database']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Databases.prototype.beginCreateOrUpdate = function (resourceGroupName, serverName, databaseName, parameters, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/databases/{databaseName}';
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      var requestModelMapper = new client.models['Database']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Databases.prototype.deleteMethod = function (resourceGroupName, serverName, databaseName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Send request
  this.beginDeleteMethod(resourceGroupName, serverName, databaseName, options, function (err, parsedResult, httpRequest, response){
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Databases.prototype.beginDeleteMethod = function (resourceGroupName, serverName, databaseName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Databases.prototype.list = function (resourceGroupName, serverName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/databases';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{serverName}', encodeURIComponent(serverName));
  var queryParameters = [];
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['DatabaseListResult']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        var deserializationError = new Error(util.format('Error "%s" occurred in deserializing the responseBody - "%s"', error, responseBody));

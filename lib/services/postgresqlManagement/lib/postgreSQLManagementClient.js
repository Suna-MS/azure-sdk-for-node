 ...
 *
 */
function PostgreSQLManagementClient(credentials, subscriptionId, baseUri, options) {
  ...
  PostgreSQLManagementClient['super_'].call(this, credentials, options);
...
util.inherits(PostgreSQLManagementClient, ServiceClient);

module.exports = PostgreSQLManagementClient;
